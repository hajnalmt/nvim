...
return {
  ...
  init = function()
   ...
   keys = {
     ...
     { '<leader>gG', '<cmd>Git add --all<CR> | <cmd>Git commit --amend --no-edit -s<CR> | <cmd>Git push --force -u origin HEAD<CR>', desc = '[G]it auto-[G]o (add, amend, force push)' },
     { '<leader>gg', '<cmd>Git add --all<CR> | <cmd>Git commit --amend --no-edit -s<CR> | <cmd>Git push -u origin HEAD<CR>', desc = '[G]it auto-[G]o (add, amend, push)' },
   },
}
